...
import { AttireComplianceSettingsPage } from "./AttireComplianceSettingsPage";

export function SettingsPage() {
  const [activeModule, setActiveModule] = usePersistedState<
    "lost-found" | "attire"
  >("settings:activeModule", "lost-found");
  ...
  return (
    <main className="flex-1 flex flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-hidden">
        {activeModule === "lost-found" ? (
          <LostAndFoundSettingsPage />
        ) : (
          <AttireComplianceSettingsPage />
        )}
      </div>
    </main>
  );
